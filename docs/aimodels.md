...
| **Meta's Nougat**        | Designed to transcribe (scientific) texts published in PDF format into Markdown format.  <br> - Utilizes Visual Transformer models for accurate text and formula recognition. | - Primarily focused on scientific documents.  <br> - May require adaptation for historical texts. | [Nougat](https://facebookresearch.github.io/nougat/) |
